      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {TOP_PRODUCTS.map((product) => (
            <div 
              key={product.id} 
              className="top-product-card group flex flex-col bg-charcoal rounded-2xl overflow-hidden border border-gold/10 hover:border-gold/30 transition-all duration-500 hover:shadow-[0_8px_30px_rgb(0,0,0,0.5)]"
            >
