...
const ITEMS = [
  {
    ...
    url: "/works/477089817_608102248728626_1688917684253117922_n.jpg",
    tall: false,
  },
  {
    id: "2",
  ...
  },
  {
    ...
    frame: "Glossy Lamination",
    url: "/works/482979563_605933535612164_6920470823351063224_n.jpg",
    tall: false,
  },
  {
    id: "6",
        ...
        <div className="columns-1 sm:columns-2 lg:columns-3 gap-4 space-y-4">
          {ITEMS.map((item, idx) => (
            <Link
              ...
              className={clsx(
                "break-inside-avoid relative overflow-hidden group block reveal-cat bg-obsidian",
