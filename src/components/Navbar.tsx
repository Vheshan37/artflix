...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      >
        ART<span className="text-gold">FLICS</span>
      </Link>
      ...
      <div className="flex items-center gap-6">
        ...
        <Link
          href="#product"
          className="text-[10px] font-normal tracking-[0.2em] uppercase text-gold border border-gold/40 px-6 py-2.5 transition-all duration-300 hover:bg-gold hover:text-obsidian magnetic"
        >
          Inquire
        </Link>
      </div>
